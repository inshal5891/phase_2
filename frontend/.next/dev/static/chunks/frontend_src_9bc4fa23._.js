...
;
// Base API URL from environment - defaults to backend on port 8001 during development
const API_BASE_URL = ("TURBOPACK compile-time value", "http://localhost:8001/api") || 'http://localhost:8001/api';
...
const registerUser = async (userData)=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/auth/register', userData);
...
const loginUser = async (credentials)=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/auth/login', credentials);
...
const getCurrentUser = async ()=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('/auth/me');
        return response.data;
    } catch (error) {
...
//# sourceMappingURL=frontend_src_9bc4fa23._.js.map